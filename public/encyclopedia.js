...
/* scopeId */
var __vue_scopeId__ = "data-v-a9fa3820"
/* moduleIdentifier (server only) */
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-a9fa3820", Component.options)
  } else {
    hotAPI.reload("data-v-a9fa3820", Component.options)
  }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(7)("998bc4aa", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-a9fa3820\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./States.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-a9fa3820\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./States.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_search_select_dist_VueSearchSelect_css__ = __webpack_require__(31);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_search_select__ = __webpack_require__(32);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: "States",
  components: {
    ModelSelect: __WEBPACK_IMPORTED_MODULE_1_vue_search_select__["ModelSelect"]
  },
  data: function data() {
    return {
      state_list: [],
    ...
    SelectBox: function SelectBox() {
      ...
      axios.get('/api/state').then(function (response) {
        for (var i = 0; i < response.data.length; i++) {
          _this2.options.push({ value: response.data[i].name, text: response.data[i].name });
        }
      });
    },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-a9fa3820", module.exports)
  }
}
