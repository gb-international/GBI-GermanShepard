  ...
  methods: {
    ...
    userData: function userData() {
      ...
      this.$axios.post("/api/payment-tour", data, {
        ...
        _this2.teacherform.amount = _this2.userinfo.tour_price;

        if (_this2.userinfo.profession == "teacher") {
          _this2.teacherform.added_by = 'teacher';
          _this2.teacherform.amount = _this2.userinfo.tour_price * _this2.userinfo.no_of_person;

          _this2.bankNameList();
        }

        _this2.tour_price = _this2.teacherform.amount;

        if (_this2.userinfo.profession == "student") {
          _this2.StudentBank();
        }
      })["catch"](function (error) {
    ...
    submitPayment: function submitPayment() {
      ...
      if (this.teacherform.payment_mode == "self" && this.teacherform.payment_type == "cheque") {
        ...
        this.chequePage = true; // this.$router.push(`/payment-mode/${this.$route.params.id}`);
      }
                ...
                _c("form", [
                  _c("div", { staticClass: "row" }, [
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.userinfo.no_of_person,
                            expression: "userinfo.no_of_person"
                          }
                        ],
                        staticClass: "form-control grey-border",
                        attrs: { type: "text", readonly: "" },
                        domProps: { value: _vm.userinfo.no_of_person },
                        on: {
                    ...
                    _c("div", { staticClass: "col-sm-4" }, [
                      _c("label", { attrs: { for: "price" } }, [
                        _vm._v("Tour Price "),
                        _vm.teacherform.added_by == "teacher"
                          ? _c("small", [
                              _c("b", [
                                _vm._v(
                                  " (" +
                                    _vm._s(_vm.userinfo.no_of_person) +
                                    " * " +
                                    _vm._s(_vm.userinfo.tour_price) +
                                    ")"
                                )
                              ])
                            ])
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.tour_price,
                            expression: "tour_price"
                          }
                        ],
                        staticClass: "form-control grey-border",
                        attrs: { type: "text", readonly: "" },
                        domProps: { value: _vm.tour_price },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.tour_price = $event.target.value
                          }
                        }
                      })
                    ])
                  ...
                  _c("div", { staticClass: "row" }, [
                    _c("div", { staticClass: "col-sm-12" }, [
                      _vm.userinfo.profession == "student"
                              ...
                              ? _c("div", { staticClass: "col-sm-6" }, [
                                  ...
                                  _c("div", { staticClass: "ml-5" }, [
                                    ...
                                    _c("div", { staticClass: "row" }, [
                                      ...
                                      _c("div", { staticClass: "col" }, [
                                        _vm._v(
                                          _vm._s(_vm.student_bank.bank_name)
                                        )
                                      ])
                                    ]),
                                    _vm._v(" "),
                                    _c("div", { staticClass: "row" }, [
                                      ...
                                      _c("div", { staticClass: "col" }, [
                                        _vm._v(
                                          _vm._s(
                                            _vm.student_bank.account_number
                                          )
                                        )
                                      ])
                                    ]),
                                    ...
                                    _c("div", { staticClass: "row" }, [
                                      ...
                                      _c("div", { staticClass: "col" }, [
                                        _vm._v(
                                          _vm._s(_vm.student_bank.ifsc_code)
                                        )
                                      ])
                                    ])
                                  ])
                    ...
                    _c("div", { staticClass: "col-sm-4" }, [
                      ...
                      _vm._v(" "),
                      _vm.userinfo.profession == "teacher"
