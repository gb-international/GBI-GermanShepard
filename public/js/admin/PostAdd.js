...
/* harmony import */ var _admin_components_buttons_FormButtons_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @/admin/components/buttons/FormButtons.vue */ "./resources/js/admin/components/buttons/FormButtons.vue");
/* harmony import */ var _admin_components_buttons_SubmitButton_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/admin/components/buttons/SubmitButton.vue */ "./resources/js/admin/components/buttons/SubmitButton.vue");
/* harmony import */ var _admin_components_layout_FormLayout_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @/admin/components/layout/FormLayout.vue */ "./resources/js/admin/components/layout/FormLayout.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    'form-buttons': _admin_components_buttons_FormButtons_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
    'submit-button': _admin_components_buttons_SubmitButton_vue__WEBPACK_IMPORTED_MODULE_7__["default"],
    'form-layout': _admin_components_layout_FormLayout_vue__WEBPACK_IMPORTED_MODULE_8__["default"]
  },
  data: function data() {
    return {
  ...
  methods: {
    ...
    AddPost: function AddPost() {
      ...
      this.form.post("/api/posts").then(function (response) {
        // this.form.reset();
        _this3.$swal.fire("Added!", "Item Added successfully", "success");
      })["catch"](function () {});
    },
