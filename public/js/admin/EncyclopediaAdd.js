...
/* harmony import */ var _admin_components_form_StatusDropdown_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/admin/components/form/StatusDropdown.vue */ "./resources/js/admin/components/form/StatusDropdown.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    "status-dd": _admin_components_form_StatusDropdown_vue__WEBPACK_IMPORTED_MODULE_7__["default"]
  },
  ...
  methods: {
    ...
    changeImage: function changeImage(event, model) {
      ...
      reader.onload = function (event) {
        switch (model) {
          case "thumbnail":
            _this4.form.thumbnail.push({
              name: file.name,
              file: event.target.result
            });

            _this4.images["thumbnail"] = event.target.result;
            break;

          case "banner":
            _this4.form.banner_image.push({
              name: file.name,
              file: event.target.result
            });

            _this4.images.banner_image = event.target.result;
            break;
