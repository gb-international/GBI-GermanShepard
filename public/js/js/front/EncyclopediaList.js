...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  metaInfo: {
    ...
    meta: [{
      name: 'description',
      content: 'Explore places on our encyclopedia pages and get in depth knowledge about culture. Itineraries and culinary of different places| only with GOwithGBI'
    }, {
      name: 'keywords',
      ...
      name: 'url',
      content: 'https://www.gowithgbi.com/travel-encyclopedia'
    }]
  },
  components: {
