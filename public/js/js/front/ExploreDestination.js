...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  metaInfo: {
    ...
    meta: [{
      name: "description",
      content: "Best travel agency in India| explore India with best deals for tours and travel packages only on GowithGBI."
    }, {
      name: "keywords",
  ...
  return _vm.apiFailed
    ...
    : _c("div", { attrs: { id: "exploreDestination" } }, [
        _c(
          "div",
          {
            staticClass: "text_on_image banner_bg2 explore_bg_img",
            class: "explore_banner_" + _vm.clientType,
          },
          [
                          ...
                          _vm.panel == "Itinerary"
                            ? _c(
                                "div",
                                {
                                  staticClass: "pb-1",
                                  class:
                                    _vm.clientType == "Student"
                                      ? "explor-content"
                                      : "explor-" + _vm.clientType,
                                },
                                [
                                  _vm.tripType == "return"
                                    ? _c("div", { staticClass: "container" }, [
                                        ...
                                        _c(
                                          ...
                                          [
                                            _c(
                                              ...
                                              {
                                                staticClass:
                                                  "btn-defalt btn-lg center-block",
                                                class:
                                                  _vm.clientType == "Student"
                                                    ? "explore_custom_button"
                                                    : "explore_custom_button_" +
                                                      _vm.clientType,
                                                attrs: { type: "submit" },
                                                on: {
                                                  click: [
