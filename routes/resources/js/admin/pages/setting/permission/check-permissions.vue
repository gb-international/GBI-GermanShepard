    ...
    <template #table>
      ...
      >
        ...
        <button
            ...
            @click.prevent="deleteItem(data.item.id)"
            >
        Remove
        </button>
      </template>
...
export default {
  ...
  data() {
    return {
      fields: [
        {key:'permission',label:'Permission',sortable:true,thClass: 'table-head'},
        {key:'create',label:'Create',sortable:true,thClass: 'table-head'},
        {key:'view',label:'View',sortable:true,thClass: 'table-head'},
        {key:'edit',label:'Update',sortable:true,thClass: 'table-head'},
        {key:'delete',label:'Delete',sortable:true,thClass: 'table-head'},
        {key:'publish',label:'Publish',sortable:true,thClass: 'table-head'},
  ...
  methods: {
    ...
    deleteItem(id,index=-1) {
      ...
      axios.get("/api/permission/remove/"+id).then((res) => {});
      this.getitems();
    },
  },
};
