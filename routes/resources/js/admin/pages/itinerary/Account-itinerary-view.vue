              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input
                    ...
                    class="form-control"
                    name="no_of_client"
                    v-model="form.no_of_client"
                    :class="{ 'is-invalid': form.errors.has('no_of_client') }"
                    readonly=""
                  />
              ...
              <div class="col-sm-4" v-if="booking_fieldz">
                <div class="form-group">
                  ...
                  <input
                    ...
                    :class="{ 'is-invalid': form.errors.has('booking_id') }"
                  />
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group text-center">
                  <router-link
                    class="btn btn-success itrn_add_btn back_btn"
                    :to="`/account-itinerary`"
                    >Back</router-link
                  >
                  <span v-if="form.selling_price != null">
                    ...
                    <button
                      type="button"
                      class="btn btn-primary itrn_add_btn cancel"
                      @click="BookingCancel()"
                    >
                      CANCEL
                    </button>
...
export default {
  ...
  methods: {
    ...
    getData(){
      let api = `/api/accounts/${this.$route.params.id}`;
    ...
    editSalesdp() {
      if (this.booking_fieldz == false) {
        ...
        this.form
          .post(`/account/update/${this.$route.params.id}`)
          .then((response) => {
