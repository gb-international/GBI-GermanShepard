...
Route::namespace('Admin')->group(function (){
	...
	Route::middleware(['role.auth'])->group(function(){
		...
		Route::namespace('RoleAndPermission')->group(function(){
			Route::get('rolecategory/all/{size}','RoleCategoryController@all');
			...
			Route::get('permission/keys','PermissionController@getPermissionKeys');
			Route::get('permission/{key}','PermissionController@getPermissionsByKey');
