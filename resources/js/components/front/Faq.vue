    ...
    <div id="faq">
    	 <section class="banner-block">
	      <div class="col-sm-12 text-center">
	        <img id="faqimg" class="top-img" :src="`assets/front/images/faq_banner.jpg`">
	          <div class="searchbarfaq input-aligment">
              <div class="row">
               <div class="col-6 col-sm-6 input-aligment offset-sm-3 ">
	             <h1>Frequently Asked Questions (FAQ)</h1> 
              </div>
            </div>
             <div class="row">
              <div class="col-6 col-sm-6 input-aligment">
	          <input type="text" class="searchbar-faq form-control" id="myInputs" placeholder="Search for Questions.." title="Type in a name">
	        </div>
        </div>
	      </div>
	  </div>
