<template>
    <div class="container">
              ...
              <div class="container">
                <div class="avatar-upload">
                 <form role="form" enctype="multipart/form-data">
                    ...
                    <button v-if="showsubmit" type="submit" class="btn uploadIcon"  @click="uploadImage" title="Upload Image"><i class="fas fa-upload"></i></button>
                  </form>
                </div>
            </div>
      ...
      <div class="container" id="dashboard_body">
        ...
        <h4>Popular Destination <a href="#">View More</a></h4>
        ...
        <h4>Recent Search <a href="#">View More</a></h4>
  ...
  import Slick from 'vue-slick';
    ...
    export default {
       ...
       methods:
       {
        ...
        uploadImage(){
          var api = "/api/imageupdate/"+this.$session.get('user_id');
          axios.post(api,{photo: this.image}).then(response => {
            toast({
                type: 'success',
