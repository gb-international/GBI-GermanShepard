                    ...
                    <div id="home" class="container tab-pane active"><br>
                      ...
                      <div class="row p-0">
                        <div class="col-6 col-sm-4 col-sm-4 col-lg-4 input-p nopadding"> 
                          <input type="text" @input="onChange" v-model="search" name="search" placeholder="Enter Your Source">
                        ...
                        <div class="col-6 col-sm-4 col-sm-4 col-lg-4 input-p nopadding"> 
                           <input  type="text" @input="onChanges" v-model="searchs" name="searchs" placeholder="Enter Your Destination">
                       ...
                       <div class="row p-0">
                        ...
                        <div class="col-6 col-sm-2 col-lg-2 input-p nopadding">
                          ...
                          <select  class="selectpicker">
                            <option selected>Type of travel</option>
