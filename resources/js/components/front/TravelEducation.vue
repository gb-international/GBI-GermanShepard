<template>
   ...
   />
    ...
    <div class="text_on_image">
      <section class="banner-block education_banner"></section>  
      <div class="content">
  ...
  <!-- End banner area -->
	  <div class="container">
		...
		<section class="section-edu">
		  ...
		  <h2>Real education happens outside the classroom and travel is the best way to learn. Get the opportunity to engage with the real. 
		</h2>
		  <article class="edu-blockcontent">
		    <div class="col-sm-12">
		     	<figure v-lazyload class="image__wrapper">
		          <ImageSpinner class="image__spinner" />
		          <img class="image__item" :data-url="`/assets/front/images/img/edu1.png`" alt="GBI science">
		        </figure>
		  ...
		  <article class="edu-blockcontent border-leftcontent">
		     <div class="col-sm-12">
		     	<figure v-lazyload class="image__wrapper">
		          <ImageSpinner class="image__spinner" />
		          <img class="image__item" :data-url="`/assets/front/images/img/edu2.png`" alt="GBI flora">
		        </figure>
		  ...
		  <article class="edu-blockcontent border-leftcontent">
		     <div class="col-sm-12">
		     	<figure v-lazyload class="image__wrapper">
		          <ImageSpinner class="image__spinner" />
		          <img class="image__item" :data-url="`/assets/front/images/img/edu3.png`" alt="GBI adventure">
		        </figure>
		  ...
		  <article class="edu-blockcontent border-topcontent">
		     <div class="col-sm-12">
		     	<figure v-lazyload class="image__wrapper">
		          <ImageSpinner class="image__spinner" />
		          <img class="image__item" :data-url="`/assets/front/images/img/edu4.png`" alt="GBI heritage">
		        </figure>
		  ...
		  <article class="edu-blockcontent border-topcontent border-leftcontent">
		     <div class="col-sm-12">
		     	<figure v-lazyload class="image__wrapper">
		          <ImageSpinner class="image__spinner" />
		          <img class="image__item" :data-url="`/assets/front/images/img/edu5.png`" alt="GBI brand">
		        </figure>
		  ...
		  <article class="edu-blockcontent border-topcontent border-leftcontent">
		     <div class="col-sm-12">
		     	<figure v-lazyload class="image__wrapper">
		          <ImageSpinner class="image__spinner" />
		          <img class="image__item" :data-url="`/assets/front/images/img/edu6.png`" alt="GBI history">
		        </figure>
