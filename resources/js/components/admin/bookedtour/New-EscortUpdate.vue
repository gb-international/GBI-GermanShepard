      ...
      <div class="col-md-12">
        <div class="container container_admin_body">
          <div class="reservation">
            <h5 class="mb-3"><img class="back-icon cursor-pointer" @click="$router.go(-1)" src="/assets/front/icons/back.png"> Escort Update</h5>
            <div class="ml-4">
              <div class="ml-1">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="text-center border-0">{{ escort.total_male }}</td>
                        <td class="text-center border-0">{{ escort.absent_male }}</td>
                      </tr>
...
export default {
  ...
  methods: {
    escortUpdate() {
      axios.get(`/api/escortUpdates/${this.$route.params.tour_code}`).then(response => {
        this.escort = response.data;
      });
    },
    goBack() {
