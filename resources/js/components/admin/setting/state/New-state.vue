                  ...
                  <div class="row">        
                      <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select class="form-control"  v-model.lazy="country_id">
                              <option v-for="data in country_list" :value="data.id">{{ data.name }}</option>
                            </select>
                      ...
                      <div class="col-sm-8">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"  placeholder="Enter State Name" v-model="form.name" :class="{ 'is-invalid': form.errors.has('name') }">
