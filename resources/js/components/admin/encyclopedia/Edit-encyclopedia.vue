          ...
          <form role="form" enctype="multipart/form-data" @submit.prevent="addItinerary()">
              ...
              <div class="row">
                ...
                <div class="col-sm-9">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="6" v-model="form.map_link" :class="{ 'is-invalid': form.errors.has('map_link') }" placeholder="Enter Map Link" ></textarea>
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <img :src="getImgUrl(form.image_one)" alt="" class="image_one" width="80" height="80">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <img :src="getImgUrl(form.image_two)" alt="" class="image_two" width="80" height="80">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <img :src="getImgUrl(form.image_three)" alt="" class="image_three" width="80" height="80">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <img :src="getImgUrl(form.image_four)" alt="" class="image_four" width="80" height="80">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <img :src="getImgUrl(form.image_five)" alt="" class="image_five" width="80" height="80">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <img :src="getImgUrl(form.image_six)" alt="" class="image_six" width="80" height="80">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <img :src="getImgUrl(form.image_seven)" alt="" class="image_seven" width="80" height="80">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <img :src="getImgUrl(form.image_eight)" alt="" class="image_eight" width="80" height="80">
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="row">
                    <div class="col-sm-12"  v-for="pdf in pdf_list">
...
// import '././components/partials/_loader.vue';
export default {
  name: "New",
  components: {
    ModelSelect
