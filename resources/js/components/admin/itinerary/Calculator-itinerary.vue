      ...
      <div class="row" >
        <div class="col-md-12 calculator">
          <div class="container container_admin_body">
              ...
              <h6>Hotel</h6>
                <form class="form">
                  <div class="row">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-2">
                              ...
                              <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" :id="index+'1'" name="example1" :value="data.apai_single/1" v-model="hotel_selected" @click="check($event)">
                                <label class="custom-control-label" :for="index+'1'">{{ data.apai_single }}/-</label>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-2">
                              ...
                              <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" :id="index+'2'" name="example1" :value="data.apai_double/2" v-model="hotel_selected" @click="check($event)">
                                <label class="custom-control-label" :for="index+'2'">{{ data.apai_double }}/-</label>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-2">
                              ...
                              <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" :id="index+'3'" name="example1" :value="data.apai_triple/3" v-model="hotel_selected" @click="check($event)">
                                <label class="custom-control-label" :for="index+'3'">{{ data.apai_triple }}/-</label>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-2">
                              ...
                              <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" :id="index+'4'" name="example1" :value="data.apai_quad/4" v-model="hotel_selected" @click="check($event)">
                                <label class="custom-control-label" :for="index+'4'">{{ data.apai_quad }}/-</label>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-2">
                              ...
                              <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" :id="index+'5'" name="example1" :value="data.mapai_single/1" v-model="hotel_selected" @click="check($event)">
                                <label class="custom-control-label" :for="index+'5'">{{ data.mapai_single }}/-</label>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-2">
                              ...
                              <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" :id="index+'6'" name="example1" :value="data.mapai_double/2" v-model="hotel_selected" @click="check($event)">
                                <label class="custom-control-label" :for="index+'6'">{{ data.mapai_double }}/-</label>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-2">
                              ...
                              <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" :id="index+'7'" name="example1" :value="data.mapai_triple/3" v-model="hotel_selected" @click="check($event)">
                                <label class="custom-control-label" :for="index+'7'">{{ data.mapai_triple }}/-</label>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-2">
                              ...
                              <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" :id="index+'8'" name="example1" :value="data.mapai_quad/4" v-model="hotel_selected" @click="check($event)">
                                <label class="custom-control-label" :for="index+'8'">{{ data.mapai_quad }}/-</label>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-2">
                              ...
                              <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" :id="index+'9'" name="example1" :value="data.cpai_single/1" v-model="hotel_selected" @click="check($event)">
                                <label class="custom-control-label" :for="index+'9'">{{ data.cpai_single }}/-</label>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-2">
                              ...
                              <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" :id="index+'10'" name="example1" :value="data.cpai_double/2" v-model="hotel_selected" @click="check($event)">
                                <label class="custom-control-label" :for="index+'10'">{{ data.cpai_double }}/-</label>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-2">
                              ...
                              <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" :id="index+'11'" name="example1" :value="data.cpai_triple/3" v-model="hotel_selected" @click="check($event)">
                                <label class="custom-control-label" :for="index+'11'">{{ data.cpai_triple }}/-</label>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-2">
                              ...
                              <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" :id="index+'12'" name="example1" :value="data.cpai_quad/4" v-model="hotel_selected" @click="check($event)">
                                <label class="custom-control-label" :for="index+'12'">{{ data.cpai_quad }}/-</label>
                              </div>
                            </div>
                          </div>
                          <hr>
                    ...
                    <div class="col-sm-1">
                      <div class="col-sm-1">
                        <button type="button" class="btn btn_plus text-white" title="Add Row" @click="add_row('hotel')"><i class="fas fa-plus"></i></button>
                      </div>                     
                    </div>
                  </div>
                </form>
            ...
            <div class="card_calculator">
              <div class="bus">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-1">
                    <div class="col-sm-1">
                      <button type="button" class="btn btn_plus text-white" title="Add Row" @click="add_row('bus')"><i class="fas fa-plus"></i></button>
                    </div>                  
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-sm-11">
                    <div class="row" v-for="(train_data,index) in train_row">
                      ...
                      <div class="col-sm-3">
                        <label>Price</label>
                        <input type="number" name="price" v-model="train_data.price">
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-1">
                    <div class="col-sm-1">
                      <button type="button" class="btn btn_plus text-white" title="Add Row" @click="add_row('train')"><i class="fas fa-plus"></i></button>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-sm-11">
                    <div class="row" v-for="(flight_data,index) in flight_row">
                      ...
                      <div class="col-sm-3">
                        <label>Price</label>
                        <input type="number" name="price" v-model="flight_data.price">
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-1">
                    <div class="col-sm-1">
                      <button type="button" class="btn btn_plus text-white" title="Add Row" @click="add_row('flight')"><i class="fas fa-plus"></i></button>
                    </div>
                  </div>
                </div>
            ...
            <div class="card_calculator">
              <div class="bus">
                ...
                <div class="row">
                  <div class="col-sm-11">
                    <div class="row" v-for="(sight_data,index) in sight_row">
                      ...
                      <div class="col-sm-3">
                        ...
                        <div class="custom-control custom-checkbox">
                          <input type="checkbox" class="custom-control-input" :id="index+'adult'" name="example1" :value="sight_data.adult_price" v-model="sight_selected" @click="check($event)">
                          <label class="custom-control-label" :for="index+'adult'">{{ sight_data.adult_price }}/-</label>
                        </div>
                      </div>
                      <div class="col-sm-3">
                        <label>Child Price</label>   
                        <div class="custom-control custom-checkbox">
                          <input type="checkbox" class="custom-control-input" :id="index+'child'" name="example1" :value="sight_data.child_price" v-model="sight_selected" @click="check($event)">
                          <label class="custom-control-label" :for="index+'child'">{{ sight_data.child_price }}/-</label>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-1">
                    <div class="col-sm-1">
                      <button type="button" class="btn btn_plus text-white" title="Add Row" @click="add_row('sight')"><i class="fas fa-plus"></i></button>
                    </div>
                  </div>
                </div>
            ...
            <div class="card_calculator">
              <div class="bus">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-1">
                    <div class="col-sm-1">
                      <button type="button" class="btn btn_plus text-white" title="Add Row" @click="add_row('escort')"><i class="fas fa-plus"></i></button>
                    </div>
                  </div>
                </div>
            ...
            <div>
              <p class="text-center">
                <router-link :to="`/itinerary-list`" class="btn btn-primary itrn_add_btn back_btn">
                  Back
                </router-link>
                <button type="button" class="btn itrn_add_btn" @click="sumData()">Submit</button>
              </p>
            </div>
    ...
    export default {
        ...
        data(){
          return{
            ...
            escort_selected:[],
            hotel_row: [
              { hotel_id: '',apai_single: '',apai_double: '',apai_triple:'',apai_quad:'',mapai_single: '',mapai_double: '',mapai_triple:'',mapai_quad:'',cpai_single: '',cpai_double: '',cpai_triple:'',cpai_quad:''},
            ],
            bus_row:[
              {bus_id:'',seater:'',seat_type:'',price:''},
            ],
            train_row:[
              {train_id:'',code:'',price:0},
            ],
            flight_row:[
              {flight_id:'',code:'',price:0},
            ],
            sight_row:[
              {sight_id:'',city:'',adult_price:'',child_price:''},
            ],
            escort_row:[
              {escort_id:'',phoneno:'',salaryPerday:''}
            ],
       ...
       methods:
       {
          ...
          add_row(type){
            if(type == 'hotel'){
              this.hotel_row.push({hotel_id: '',apai_single: '',apai_double: '',apai_triple:'',apai_quad:'',mapai_single: '',mapai_double: '',mapai_triple:'',mapai_quad:'',cpai_single: '',cpai_double: '',cpai_triple:'',cpai_quad:''});
              ...
              this.sight_row.push({sight_id:'',city:'',adult_price:'',child_price:''});
            }
            else if(type == 'escort'){
