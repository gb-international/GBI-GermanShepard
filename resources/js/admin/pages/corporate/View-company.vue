...
Creator: @Manas
This template helps us to view a company. 

-->
<template>
  <view-layout backurl="/companies">
    <template #viewdata>
      <div class="row pl-3">
        <div class="col-sm-3">
          <h5>Name</h5>
          <p>{{ client_view.company_name }}</p>
        </div>
        <div class="col-sm-3">
          <h5>Street</h5>
        ...
        <div class="col-sm-3">
          <h5>Primary Email</h5>
          <p>{{ client_view.incharge_email_id }}</p>
        </div>

        <div class="col-sm-3">
          <h5>Secondary Email</h5>
          <p>{{ client_view.company_email_id }}</p>
        </div>
