...
-->
<template>
  <list-layout addurl="/add-departments" buttontext="add department">
    <template #perpage>
      <b-form-group
        label="Per page"
    ...
    <template #table>
      ...
      >
        ...
        <template #cell(action)="data">
          <edit-icon :url="`/edit-departments/${data.item.id}`"></edit-icon>
          <delete-icon 
...
export default {
  ...
  methods: {
    ...
    deleteItem(id,index=-1) {
      let payload = {'api':"/departments/"+id,index,'index':index};
