          ...
          <div class="card_view">
            ...
            <div class="row">
              ...
              <div class="col-sm-6 text-center" v-if="user.information">
                  <img :src="`/uploadimage/${user.information.photo}`" class="img-circle w-80">
              </div>
            </div>
            <div class="information" v-if="user.information">
                <div class="row">
                    ...
                    <div class="col-sm-6" v-if="user.information.school_id != null">
                        <h5>School</h5>
                        <p><router-link :to="`/view-school/${user.information.school.id}`">{{user.information.school.school_name}} (ID : {{ user.information.school.id }})</router-link></p>
                    </div>

                    
                    <div class="col-sm-6" v-if="user.information.user_profession =='corporate'">
                        <h5>Corporate</h5>
                        <p>{{user.information.profession_name}}</p>
                        <p><b>Address: </b>{{ user.information.profession_address }}</p>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <h5>Address</h5>
                        <p>{{user.information.address }} {{ user.information.city }},{{ user.information.zip_code }}, {{ user.information.state }},{{ user.information.country }}</p>
                    </div>
                </div>
