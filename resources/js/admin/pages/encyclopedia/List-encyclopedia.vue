      ...
      <div class="col-md-12">
        <div class="container container_admin_body">
          ...
          >
            ...
            <tbody>
              <tr
                v-for="encyclopedia in encyclopedia_list"
                role="row"
              ...
              >
                ...
                <td>
                  <img :src="getImgUrl(encyclopedia.thumbnail)" />
                </td>
                <td>
                  <img :src="getImgUrl(encyclopedia.banner_image)" />
                </td>
                <td class="edit_section">
                  ...
                  <a href class="delete_link" @click.prevent="deleteencyclopedia(encyclopedia.id)">
