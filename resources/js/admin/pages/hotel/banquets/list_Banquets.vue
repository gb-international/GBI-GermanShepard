<!--
This page is used to list Banquet data
-->
<template>
  <list-layout addurl="/add-banquet" buttontext="add Banquet">
    <template #perpage>
      <b-form-group
        label="Per page"
     ...
     <section class="customCard card card-1" style="background: white !important" v-for="data in items.data" :key="data.id">
      <div class="MainRow">
        <div class="d-flex flex-column justify-content-start align-items-start mainRow1">
          ...
          <p class="amenP"><i class="fas fa-crown mr-2"></i>Deluxe Category</p>
          <p class="amenP"><i class="fas fa-wind mr-2"></i>Air Condition</p>
          <p class="amenP"><i class="fas fa-wifi mr-2"></i>Free Wifi</p>
          <p class="amenity">Amenities</p>
        </div>
        <div class="detailsRow">
          <p class="guests">{{data.banquets}} Banquets</p>
...
export default {
  ...
  methods: {
    ...
    deleteItem(id,index=-1) {
      let payload = {'api':"/banquet/"+id,index,'index':index};
