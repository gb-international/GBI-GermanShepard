        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <select class="form-control select-field" v-model="form.bus_id">
                <option value="" disabled hidden>Select Bus</option>
                <option v-for="bus in bus_list" :key="bus.id" :value="bus.id">
                  {{ bus.company_name }}
                </option>
              </select>
