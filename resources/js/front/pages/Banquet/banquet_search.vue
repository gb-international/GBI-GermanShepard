    ...
    <div class="MainRow">
      <div class="d-flex flex-column justify-content-start align-items-start mainRow1">
        ...
        <div class="d-flex stars">
         ...
         <p class="amenP"><i class="fas fa-crown mr-2"></i>Guests Lounge</p>
...
export default {
  ...
  methods: {
    getHotels(){
      ...
      this.searchForm.post("/api/banquet-search").then(response => {
        ...
        if(response.data.length <= 0){
          this.$swal.fire("Sorry", "No Banquets found.", "info");
