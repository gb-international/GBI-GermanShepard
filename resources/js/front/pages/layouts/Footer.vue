          ...
          <div class="container">
            <div class="row text-white pt-5">
              <div class="col-sm-3">
                ...
                <router-link class="text-white d-block pb-1" to="/explore-destination">Explore Destination</router-link>
      ...
      <div class="m-bottom">
        ...
        <div class="navbar-bottom">
          ...
          <div class="row text-center text-uppercase">
            <div class="col" @click="makeActive(0)" :class="{ mobile_nav_active : active_element == 0 }">
              <router-link :to="`/`" >
                <div class="nav-font">
            ...
            <div class="col"  @click="makeActive(1)" :class="{ mobile_nav_active : active_element == 1 }">
