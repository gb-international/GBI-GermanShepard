<template>
    <div>
                <div id="AlertModalForExplore" class="modal fade modal-border-radius" role="dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body p-2">
                <div class="text-center modal-padding">
                 ...
                 <button type="button" class="btn swal-close-button mt-3 text-center" data-dismiss="modal">OK</button>
                </div>

                <p data-dismiss="modal" class="modal-footer-link-custom">For Itinerary <span class="pointer" data-toggle="modal"
            data-target="#itinerayrFormModal">Click Here</span></p>
              </div>
            </div>
              ...
              <div class="modal-body">
                <form class="form p-3" method="post" @submit.prevent="submitForm()">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn swal-close-button mt-3 text-center">OK</button>
    ...
    methods:{
        submitForm(){
            ...
            this.form.post('/api/request-itinerary').then((res)=>{
                this.form.reset();
                this.$swal.fire("Submited!!", "Your Query Has Been Submited !!", "success");
