<template>
  ...
  <div v-if="flights.data">
    <div v-for="(flight, index) in flights.data" :key="index">
      <div
        class="row align-items-center mb-20"
        v-if="flight.flight_date == flightDate"
      >
        <div class="col-md-3 col">
          ...
          <p>
            Flying from
            <b class="text-info"
              >{{ flight.departure.airport }} ( {{ flight.departure.iata }} )</b
            >
          </p>
        ...
        <div class="col-md-6 col-sm-6 col-xm-12 order-xm-3">
          <div class="progressbar" v-if="flight.flight_status == 'active'">
            ...
            <p class="text-center">
              Journy time left: {{ timeCalculate(flight.arrival.estimated) }}
            </p>
          </div>
          <p class="text-center w-100">
            Flight Status : <b>{{ flight.flight_status }}</b>
          </p>
        </div>
        ...
        <div class="col-md-3 col text-left">
          ...
          <P>
            Flying To
            <b class="text-info"
              >{{ flight.arrival.airport }} ( {{ flight.arrival.iata }} )</b
            >
          </P>
