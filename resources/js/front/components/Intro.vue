<template>
    ...
    <button class="position-absolute display-none" id="introButton" data-toggle="modal" data-target="#introModal"  data-backdrop="static" data-keyboard="false"></button>
                 ...
                 <div class="intro-image">
                    ...
                    <div class="intro" v-if="data">
                        ...
                        <div class="intro-footer">
                            <div class="row">
                                <div class="col">
                                    <button type="button" class="btn btn-outline-info border-radius-0 intro-btn" @click="skipIntro()">SKIP</button>
                                </div>
                                <div class="col text-right">
                                    <button type="button" class="btn btn-outline-info border-radius-0 intro-btn" @click="LeftImage()">BACK</button>
                                    <button v-if="right_btn" type="button" class="btn btn-outline-info border-radius-0 intro-btn" @click="RightImage()">NEXT</button>
                                    <button v-if="finish_btn" type="button" class="btn btn-outline-info border-radius-0 intro-btn" @click="FinishImage()">FINISH</button>
                                </div>
                            </div>
                        </div>
                    </div>
